import { Activity, Brain, Users, ShieldCheck, Globe, Heart, AlertTriangle } from 'lucide-react';
        ...
        <div className="container">
          <div style={{ maxWidth: '700px', margin: '0 auto', background: 'var(--warning-light)', border: '0.5px solid var(--warning)', borderRadius: 'var(--radius-lg)', padding: '2rem' }}>
            <div style={{ display: 'flex', alignItems: 'center', gap: '0.625rem', marginBottom: '1rem' }}>
              <AlertTriangle size={20} color="#7a5200" />
              <h3 style={{ color: '#7a5200', margin: 0 }}>Medical Disclaimer</h3>
            </div>
